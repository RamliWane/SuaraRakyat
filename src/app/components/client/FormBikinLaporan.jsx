            ...
            <form className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" placeholder="Masukkan judul laporan..." className="h-12 w-full rounded-xl border border-[#262626] bg-[#101010] px-4 text-sm text-white outline-none transition-all placeholder:text-[#666] focus:border-[#DC9B9B]" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Masukkan lokasi..." className="h-12 w-full rounded-xl border border-[#262626] bg-[#101010] px-4 text-sm text-white outline-none transition-all placeholder:text-[#666] focus:border-[#DC9B9B]" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select className="h-12 w-full rounded-xl border border-[#262626] bg-[#101010] px-4 text-sm text-white outline-none focus:border-[#DC9B9B]">
                ...
                <button
                    type="button"
                    className="flex h-12 w-full items-center justify-center rounded-xl bg-[#DC9B9B] text-sm font-medium text-white transition-all hover:bg-[#DC9B9B]/80"
                >
                    Lanjutkan
                </button>
            </form>
